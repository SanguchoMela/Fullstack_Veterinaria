...
// Importar Link para realizar navegación
import {Link} from 'react-router-dom'
// Importar useNavigate para realizar navegación
import { useNavigate } from 'react-router-dom'
// Importar Mensaje para los mensajes de alerta
import Mensaje from '../componets/Alertas/Mensaje'
// Importar el "grupo de whatsapp"
...
const Login = () => {
    ...
    // useState para capturar los datos del email y el password
    const [form, setform] = useState({
        email: "",
        password: ""
    })

    // Capturar los datos del formulario y almacenar en la variable
    ...
    // Capturados los datos del formulario se ejecuta el endpoint (/login)
